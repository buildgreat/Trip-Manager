 ...
 <?php
   ...
   // if($_SESSION['invalid']==1)
    ...
    ?>
        ...
        <div class="container" style="font-family: “Times New Roman”, Times, serif; font-size: 20px; color: black; width: 100%; background-color: chartreuse">
  <form class="form-horizontal" method="POST" action="">
    <div class="form-group">
        <br>
      <label class="control-label col-sm-5" for="tname">Trip Name:</label>
      <div class="col-sm-3">
    ...
    <div class="form-group">
      <label class="control-label col-sm-5" for="nom">No of Members:</label>
      <div class="col-sm-3">
      ...
      <div class="form-group">
        ...
        <br>
      <label class="control-label col-sm-5" for="tname">  </label>
      <div class="col-sm-3">
          <!--<input type="text" class="form-control" name="tname" placeholder="Enter Trip Name">-->
          <br>
      </div>
    </div>
  ...
  <div class="form-group">        
      ...
      <div class="col-sm-offset-2 col-md-3" style="color: chocolate">
          <br>
          <input type="submit" class="btn btn-primary" name="submit_1" value="submit"></input>
      </div>
    </div> 
  </form>
    </div>
