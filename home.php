...
<div class="container">
 ...
 <?php
    ...
    <div class="navbar navbar-inverse" style="font-size:25px; color: brown  ;font-style: bold; background-color:whitesmoke; font-family: “Times New Roman”, Times, serif;">
   ...
   // if($_SESSION['invalid']==1)
    ...
    <img src="center.jpg" style="width: 1715px;" alt="error">
    </img>
    <br>
